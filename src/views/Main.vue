...
<template>
  <div class="flex flex-col h-screen  overflow-hidden">
    <!-- 头部 -->
    <header
      class="bg-gray-100 text-white flex items-center justify-between px-0 py-2 h-8 top-0 left-0 w-full"
    >
      <!-- 头部左边的下拉框选项 -->
      <div class="flex items-center space-x-4">
        ...
        <div
          class="relative bg-gray-100 text-gray-400 hover:bg-gray-200 px-0 mx-0"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div class="relative">
          <select
            class="block appearance-none w-full bg-gray-100 border border-gray-200 text-xs text-black py-1 px-3 pr-8 rounded leading-tight focus:outline-none focus:bg-gray-100 focus:border-gray-100"
          >
            <option>选项1</option>
            <option>选项2</option>
            <option>选项3</option>
          ...
          <div
            class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-1 ml-1 text-gray-400"
          >
            <svg
        ...
        <nav class="px-4 pt-4">
          <ul class="space-y-4">
            <li>
              <a
                href="#"
                class="block text-gray-700 hover:bg-gray-400 py-2 px-4 rounded"
                >导航项1</a
              >
            </li>
            <li>
        ...
        <div class="flex-1 overflow-y-auto px-4 py-4">
          <div class="grid grid-cols-3 gap-4">
            <div v-for="image in images" :key="image.id">
              ...
              <div class="text-gray-700 mt-2 text-center">{{ image.title }}</div>
            </div>
          </div>
        </div>
      </div>
